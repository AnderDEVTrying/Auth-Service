package com.example.Auth_Service.Infra.SecurityConfig;
...
public class TokenService {
    ...
    public String generateToken(Customers customer) {
        try {
            Algorithm algorithmn = Algorithm.HMAC256(secret);
    ...
    public String validadeToken(String token) {
        try {
            ...
            throw new RuntimeException("Error while recovering token");
        }
    }
